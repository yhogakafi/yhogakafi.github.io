...
function convertToXML(data) {
    ...
    xml += '            <INVOICENO>TESTINI</INVOICENO>\n';
    xml += '            <INVOICEDATE>2024-08-21</INVOICEDATE>\n';
    xml += '            <TAX1CODE/>\n';
    xml += '            <TAX2CODE/>\n';
    ...
    xml += '            <SHIPVIA>SPX Hemat</SHIPVIA>\n';
    xml += '            <FOB/>\n';
    xml += '            <PURCHASEORDERNO/>\n';
    xml += '            <WAREHOUSEID>ONLINE</WAREHOUSEID>\n';
    xml += '            <DESCRIPTION/>\n';
    xml += '            <SHIPDATE>2024-08-03</SHIPDATE>\n';
    xml += '            <DELIVERYORDER></DELIVERYORDER>\n';
    xml += '            <FISCALRATE>1</FISCALRATE>\n';
    xml += '            <TAXDATE>2024-08-21</TAXDATE>\n';
